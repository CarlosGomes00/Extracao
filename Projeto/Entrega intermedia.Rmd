...
RNA_cpm = read.table("Dados/data_mrna_seq_cpm.txt", header = T, sep = '\t')   # Necessário ter o ficheiro na mesma diretoria
...
No entanto, nem todas as amostras foram utilizadas para o processo de análise de RNAseq. Existem dois campos nos metadados: RNA sequenced e RNA seq analysis.
...
-   **data_patient[, c(1,2,4,5,7, 8, 9, 10, 11, 12, 13, 14, 18, 20, 21)] <- lapply(data_patient[, c(1,2,4,5,7, 8, 9, 10, 11, 12, 13, 14, 18, 20, 21)], as.factor)** -\> Converte as colunas selecionadas do dataframe para fator.

Esta transformação é feita para possibilitar a análise destas colunas como variáveis categóricas.
...
```{r preparação dos dados para DE}
